...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/top.php'; ?>
		<div class="bio container">
			...
			<p>And I still make time for filmmaking pursuits&mdash;most recently having spent the prior summer editing a documentary in Thailand. <a href="https://vimeo.com/tormafilm/torma" target="_blank">Watch it here</a> (we could use the money).</p>
		</div>
