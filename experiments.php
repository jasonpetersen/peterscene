				...
				<div class="<?php echo GRIDBUCKET; ?>">
					<div class="row spacious1">
						<div class="col-xs-7 col-sm-8 col-md-9">
							...
							<p><a href="https://anonynote.net" target="_blank">Go to anonynote.net</a> <i class="fa fa-external-link"></i></p>
							<p><a href="/experiments/anonynote">Launch original in-site design</a> <i class="fa fa-hand-o-right"></i></p>
						</div>
					...
					<div class="row spacious2">
						<div class="col-xs-12">
							...
							<p>This project started life on this website as a sort of proof-of-concept, but I decided I liked it enough that it needed to be <a href="https://anonynote.net" target="_blank">its own website</a>. I spent some months on it and am very happy with how it turned out. I hope it finds a user base!</p>
